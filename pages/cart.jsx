...
const Cart = () => {
  ...
  return (
    <div className={styles.container}>
          ...
          {open ? (
            <div className={styles.paymentMethods}>
              ...
              <PayPalScriptProvider
                options={{
                  "client-id":
                    "AWxmqexC40s5IKjijEQU-2YcrM4tWSSimeKx16vkcV-6ZeZmJBrXv5lQEHZB6BWMgKsgDLUdBvuLSja9",
                  components: "buttons",
                  currency: "USD",
      ...
      {cash && <OrderDetails total={cart.total} createOrder={createOrder} setCash={setCash}/>}
    </div>
  );
};
